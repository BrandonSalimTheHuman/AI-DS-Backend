...
def load_start_sequence(training_data_path=r'C:\Users\Brandon Salim\PycharmProjects\TASem3\AI-FinalProject-Backend'
                                           r'\generation\Subset_Dataset\input_sequences_notes.pkl'):
...
def main_gru_generate_music(
    ...
    model = load_gru_model(sequence_length=50, n_unique_notes=576,
                           checkpoint_path=r'C:\Users\Brandon Salim\PycharmProjects\TASem3\AI-FinalProject-Backend'
                                           r'\generation\trained-models\weights-epoch-15-loss-3.9767-acc-0.2276'
                                           r'.weights.h5')
...
# # Test main method
# main_gru_generate_music('GRU', 100, ['C#', 'D', 'E', 'F#', 'G#', 'A', 'B'], 40, 45, 100, 0.5,
#                         [0, 0.3, 0.2, 0.15, 0.35])
